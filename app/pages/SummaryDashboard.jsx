        ...
        {contenidoActual === '/pages/DashboardAdmin' && (
          <Animatable.View animation="fadeInUp" duration={800} style={styles.summaryContainer}>
            ...
            <Text style={styles.summaryDescription}>
              Summary overview general report dashboard totals orders accounts receivable payable inventory stock balance status pending completed canceled due owed debts finances bookkeeping ledger records management data statistics metrics analysis chart graph interface display panel control board monitor screen view layout design UI user interface.
            </Text>
            <Text style={styles.dateTimeText}>
              Actualizado: 04:03 PM -05, Jueves, 10 de julio de 2025
            </Text>
